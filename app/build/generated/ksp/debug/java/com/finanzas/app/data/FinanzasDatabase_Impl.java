  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `transactions` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `amount` REAL NOT NULL, `description` TEXT NOT NULL, `category` TEXT NOT NULL, `type` TEXT NOT NULL, `date` TEXT NOT NULL, `note` TEXT NOT NULL, `isRecurring` INTEGER NOT NULL, `recurringPeriod` TEXT)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '948a42c8aef393b551e7e931952548f2')");
      }
    ...
    }, "948a42c8aef393b551e7e931952548f2", "ee4bcf07b3598365605294e8c2ac176a");
